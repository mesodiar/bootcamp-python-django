...
เข้าไปที่ www.github.com และกดปุ่มเพื่อสร้าง repository
...
#### 3.2 สร้างปลายทางที่จะไปด้วย URLS.py
...
#### การ query ดึงข้อมูลมาดูกันหน่อย

เราจะไปที่หน้าต่าง console กัน และรันคำสั่ง
...
เข้า [FontCDN: A search tool for Google web fonts](https://thomaspark.co/projects/fontcdn/) แล้วเลือกฟ้อนชื่อ PT serif
...
แล้วย้ายรูปที่ upload ไปไว้ใน /media/ รุป.jpg
...
คราวนี้เพิ่ม fontawesome แล้วเราก็สมัครโดยการใส่เมล